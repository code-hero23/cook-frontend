                ...
                <div className="max-w-6xl w-full flex flex-col items-center my-auto">
                    ...
                    >
                        ...
                        <div className="text-center mb-6">
                            <h2 className="text-xl font-black text-slate-800 tracking-tight">Access Portal</h2>
                            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">Client Login</p>
                        </div>
